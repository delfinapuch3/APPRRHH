...
INSERT INTO "new_DailyCalculation" ("ausente", "employeeId", "extrasValidadas", "fecha", "fechaValidacion", "francoGenerado", "horasExtra100", "horasExtra50", "horasManual", "horasNormales", "id", "justificada", "observaciones", "tarde", "tipoAusencia", "tipoDia", "updatedAt", "validadoPorId") SELECT "ausente", "employeeId", "extrasValidadas", "fecha", "fechaValidacion", "francoGenerado", "horasExtra100", "horasExtra50", "horasManual", "horasNormales", "id", "justificada", "observaciones", "tarde", "tipoAusencia", "tipoDia", "updatedAt", "validadoPorId" FROM "DailyCalculation";
